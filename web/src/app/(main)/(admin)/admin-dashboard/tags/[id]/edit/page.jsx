// src/app/(main)/(admin)/admin-dashboard/tags/[id]/edit/page.jsx
"use client";
...
import { fetchTagById, updateTag, deleteTag } from "@/services/adminService";
    ...
    return (
      <div className="flex items-center justify-center h-96">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300">Loading tag...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Update tag details and information
            </p>
          </div>
        </div>
      ...
      {success && (
        <div className="mb-6 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg flex items-center gap-3">
          ...
          <p className="text-green-700 dark:text-green-300">
            Tag updated successfully! Redirecting...
          </p>
        </div>
      )}
