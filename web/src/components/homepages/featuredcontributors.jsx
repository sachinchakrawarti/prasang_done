// src/components/homepages/featuredcontributors.jsx
"use client";
...
const FeaturedContributors = () => {
  ...
  const [displayedContributors, setDisplayedContributors] =
  ...
  useEffect(() => {
    ...
    setDisplayedContributors(filtered);
  ...
  // Get displayed contributors (max 6 for homepage)
  const displayContributors = displayedContributors.slice(0, 6);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
          <div>
            ...
            >
              {t("featuredContributors") || "Featured Contributors"}
            </h2>
            <p className="text-gray-600 dark:text-gray-300 mt-1">
              {t("contributorsDesc") ||
                "Meet the scholars, translators, and editors enriching our community"}
            </p>
          </div>
          <Link
        ...
        <div className="mb-8 space-y-4">
          ...
          {showFilters && (
            <div
              className={`p-4 rounded-lg border ${borderColor} bg-gray-50 dark:bg-gray-800/50 grid grid-cols-1 sm:grid-cols-3 gap-4 animate-fadeIn`}
            >
              {/* Role Filter */}
              <div>
        ...
        {displayedContributors.length > 0 && (
          <div className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
            {t("showing") || "Showing"} {displayContributors.length}{" "}
            {t("contributors") || "contributors"}
            {displayedContributors.length > 6 &&
              ` (${t("of") || "of"} ${displayedContributors.length})`}
          </div>
        )}
      </div>
    </div>
